...
VIDEOS = {
    ...
    "secretary-tutorial": {
        ...
        "title": "群組訊息，不該翻完就消失",
        "narration": """萬語通 AI 秘書，整理同一個付費群組內已留下的工作紀錄。它可以只記錄、不自動插話；自動回覆預設關閉，避免干擾現場溝通。小老鼠祕書與小老鼠秘書兩種寫法都可以。第一次使用，傳送小老鼠祕書，空格，說明，查看可用功能。再傳送小老鼠祕書，空格，狀態，確認翻譯、紀錄、摘要、日報、自動回覆與最近紀錄。需要快速整理時，傳送小老鼠祕書，空格，摘要。系統會理解群組內的多語紀錄，並以繁體中文整理重點。需要交班資料時，傳送小老鼠祕書，空格，報表。摘要依方案整理近期紀錄，官網目前標示最多可整理最近三百筆。AI 秘書協助整理，不取代主管判斷。翻譯或摘要可能有誤，高風險內容仍要回看原始紀錄並人工確認。若遇短暫延遲或暫時無法使用，請稍候再試；若問題持續，請透過官方客服反映。若查核確認涉及資安事件，將通知萬語通系統管理員處理。現在就在已開通的群組傳送小老鼠祕書，空格，說明。""",
        "slides": [
